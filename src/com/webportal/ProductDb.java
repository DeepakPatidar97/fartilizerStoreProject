...
public class ProductDb {
	...
	public void updateProduct(Product theProduct) throws Exception {
		...
		try {
			...
			preparedStatement = connection.prepareStatement(sql);
			preparedStatement.setString(1, theProduct.getProduct_name());
			preparedStatement.setString(2, theProduct.getProduct_company());
			preparedStatement.setString(3, theProduct.getProduct_variety());
			preparedStatement.setString(4, theProduct.getProduct_expairy());
			preparedStatement.setString(5, theProduct.getProduct_price());
			preparedStatement.setString(6, theProduct.getProduct_quantity());
			preparedStatement.setString(7, theProduct.getProduct_duration());
			preparedStatement.setString(8, theProduct.getId());
			preparedStatement.executeUpdate();
		}catch (Exception e) {
			e.getStackTrace();
		} finally {
	...
	/**
	 * this method is give the product information.
	 * @param id
	 * @return the list
	 * @throws Exception
	 */
